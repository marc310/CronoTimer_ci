    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Moeda Add</h3>
            </div>
            <?php echo form_open('moeda/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="simbolo" value="<?php echo $this->input->post('simbolo'); ?>" class="form-control" id="simbolo" />
