    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Projeto Add</h3>
            </div>
            <?php echo form_open('projeto/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nome_projeto" value="<?php echo $this->input->post('nome_projeto'); ?>" class="form-control" id="nome_projeto" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="descricao_projeto" value="<?php echo $this->input->post('descricao_projeto'); ?>" class="form-control" id="descricao_projeto" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="preco_projeto" class="control-label">Preco Projeto</label>
						<div class="form-group">
							<input type="text" name="preco_projeto" value="<?php echo $this->input->post('preco_projeto'); ?>" class="form-control" id="preco_projeto" />
