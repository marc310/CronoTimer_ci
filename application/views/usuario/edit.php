<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('usuario/edit/'.$usuario['user_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="tipo" class="form-control">
								...
								{
									$selected = ($value == $usuario['tipo']) ? ' selected="selected"' : "";
					...
					<!-- <div class="col-md-6">
						...
						<div class="form-group">
							<select name="cliente_id" class="form-control">
								...
								{
									$selected = ($cliente['id_cliente'] == $usuario['cliente_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="password" name="password_conf" value="<?php echo ($this->input->post('password_conf') ? $this->input->post('password_conf') : $usuario['password_conf']); ?>" class="form-control" id="password_conf" />
					...
					<div class="col-md-6" hidden>
						...
						<div class="form-group">
							<input type="text" name="data_cadastro" value="<?php echo ($this->input->post('data_cadastro') ? $this->input->post('data_cadastro') : $usuario['data_cadastro']); ?>" class="has-datetimepicker form-control" id="data_cadastro" />
						</div>
					</div>
				</div>
			</div>
