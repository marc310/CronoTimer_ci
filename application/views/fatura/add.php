    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Fatura Add</h3>
            </div>
            <?php echo form_open('fatura/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="cliente_fatura" class="form-control">
								...
								{
									$selected = ($cliente['id_cliente'] == $this->input->post('cliente_fatura')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="data_emissao" value="<?php echo $this->input->post('data_emissao'); ?>" class="has-datepicker form-control" id="data_emissao" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="data_vencimento" class="control-label">Data Vencimento</label>
						<div class="form-group">
							<input type="text" name="data_vencimento" value="<?php echo $this->input->post('data_vencimento'); ?>" class="has-datepicker form-control" id="data_vencimento" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="valor_hora" value="<?php echo $this->input->post('valor_hora'); ?>" class="form-control" id="valor_hora" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="total_fatura" value="<?php echo $this->input->post('total_fatura'); ?>" class="form-control" id="total_fatura" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="total_pendente" value="<?php echo $this->input->post('total_pendente'); ?>" class="form-control" id="total_pendente" />
