 ...
 */
$config['site_title']                 = "formulaplusrj.com.br";       // Site Title, example.com
$config['admin_email']                = "admin@marcelomotta.com"; // Admin Email, admin@example.com
...
$config['forgot_password_expiration'] = 3000;                /* The number of seconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
...
//     'smtp_user' => 'marcelomotta.dev@gmail.com', // actual values different
//     'smtp_pass' => 'jhmer123',
//     'smtp_port' => '26'
// );
